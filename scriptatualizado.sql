...
constraint fk_usuario_traducao foreign key(fkusuario) references usuario(id)
);
...
insert into musica (nome, artista, letra, genero) 
values		('Tom Sawyer', 'Rush', 'A modern-day warrior\n
			...
			Let me in your window
			Heathcliff, it\'s me, I\'m Cathy
			I\'ve come home, I\'m so cold', 'Pop');
...
values		(100, 1, 'Um guerreiro dos dias modernos
			...
			(101, 2, 'Amor, Você Deveria Ter Vindo Pra Cá
			...
			Porque não é tarde demais'),
			(102, 3, 'O Morro dos Ventos Uivantes
			...
			(102, 4, 'O Morro dos Ventos barulhentos
			Lá fora nas campinas tempestosas
			Nós rolávamos e caíamos na grama
			Seu temperamento era igual minha vergonha
			Muito ardente, muito vivo
			Como você pôde me deixar
			Quando eu precisei te possuir?
			Eu te odiei, eu te amei também
			Sonhos bons durante a noite
			Eles disseram-me que eu perderia a luta
			Deixo para trás meu morro, morro
			Morro dos ventos barulhentos
			Heathcliff, sou eu, Cathy, voltei para casa
			Estou com tanto frio, deixe-me entrar por sua janela
			Heathcliff, sou eu, Cathy, voltei para casa
			Estou com tanto frio, deixe-me entrar por sua janela
